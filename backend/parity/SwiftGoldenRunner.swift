        ...
        for testCase in fixture.cases {
            ...
            for team in teams {
                ...
                decisions[team.id] = PlayerDecision(
                    teamId: team.id, round: testCase.round,
                    pricing: PricingDecision(wholesalePrice: d.wholesalePrice, internetPrice: d.internetPrice,
                    ...
                    product: ProductDecision(materialsQuality: MaterialsQuality(rawValue: d.materialsQuality)!,
                        stylingBudget: d.stylingBudget, modelsOffered: d.modelsOffered, tqmInvestment: d.tqmInvestment),
                    marketing: MarketingDecision(advertisingBudget: d.advertisingBudget,
                        celebrityEndorsement: CelebrityEndorsement(rawValue: d.celebrityEndorsement)!, retailOutlets: d.retailOutlets,
                        mailInRebate: d.mailInRebate, deliveryTime: DeliveryTime(rawValue: d.deliveryTime)!,
                        freeShippingThreshold: d.freeShippingThreshold, tiktokBudget: d.tiktokBudget,
                        instagramBudget: d.instagramBudget, youtubeBudget: d.youtubeBudget,
                        influencerTier: InfluencerTier(rawValue: d.influencerTier)!),
                    workforce: WorkforceDecision(baseWage: d.baseWage, incentivePay: d.incentivePay,
                    ...
                    finance: FinanceDecision(csrInvestment: d.csrInvestment, dividendsPerShare: d.dividendsPerShare,
