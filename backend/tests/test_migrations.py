...
def test_migration_file_syntax():
    ...
    migrations_dir = Path("/Users/luisborges/2026/Practenture-ios/Practenture/backend/migrations/versions")
...
def test_migration_000_structure():
    ...
    migration_file = Path("/Users/luisborges/2026/Practenture-ios/Practenture/backend/migrations/versions/000_initial_schema.py")
...
def test_migration_graph_heads():
    ...
    result = subprocess.run(
        ["/Users/luisborges/2026/Practenture-ios/Practenture/backend/.venv/bin/alembic", "heads"],
        cwd="/Users/luisborges/2026/Practenture-ios/Practenture/backend",
        capture_output=True,
        text=True
    )
