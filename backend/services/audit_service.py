...
class AuditService:
    ...
    def create_audit_event(
        ...
        before_json = self._redact_sensitive_data(before_data or {})
        after_json = self._redact_sensitive_data(after_data or {})
        metadata_json = self._redact_sensitive_data(metadata or {})
