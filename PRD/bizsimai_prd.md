# BizSimAI Product Requirements Document (PRD)

## Executive Summary

BizSimAI is a real-time adaptive business simulation platform designed to teach strategic business decision-making through immersive, interactive gameplay. Unlike traditional batch-processed simulations, BizSimAI leverages WebSocket technology to provide immediate feedback on competitive moves, creating a dynamic learning environment that mirrors real-world market conditions. The platform serves both professors (as facilitators and coaches) and students (as competing business teams), with AI-powered adaptation to adjust difficulty and provide personalized learning paths based on performance.
...
BizSimAI transforms business education by:
...
| Feature                        | BizSimAI         | Capstone         | Marketplace Sim  | Cesim Global     | Hubro            |
|--------------------------------|------------------|------------------|------------------|------------------|------------------|
...
1. **Access:** Open BizSimAI app (iOS/Android) or visit web portal
...
1. **Setup:**
   - Log into professor console at professor.bizsimai.com
