...
struct AboutView: View {
    var body: some View {
        ...
        .navigationTitle("About practenture AI")
        #if os(macOS)
        .frame(minWidth: 480)
        #endif
    }
    ...
    private var howItWorksSection: some View {
        infoSection(
            ...
            VStack(alignment: .leading, spacing: 12) {
                infoParagraph(
                    "practenture AI is a marketplace simulation where teams run athletic footwear companies competing in a global marketplace. Each round, you make strategic decisions across pricing, product design, marketing, Amazon, social media, workforce, production, CSR, and finance."
                )
