...
struct TeamDashboardView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            NSLog("[Practenture] TeamDashboardView onAppear")
            NSLog("[Practenture] session exists: \\(session != nil)")
            NSLog("[Practenture] gameController exists: \\(gameController != nil)")
            NSLog("[Practenture] isProcessing: \\(gameController?.isProcessing ?? false)")
            NSLog("[Practenture] totalTeams: \\(totalTeams)")
            NSLog("[Practenture] currentRound: \\(currentRound)")
            NSLog("[Practenture] totalRounds: \\(totalRounds)")
            NSLog("[Practenture] playerTeam exists: \\(playerTeam != nil)")
            NSLog("[Practenture] cash: \\(cash)")
            NSLog("[Practenture] isOnline: \\(isOnline)")
            NSLog("[Practenture] backendCurrentRound: \\(backendCurrentRound)")
            NSLog("[Practenture] backendTeamCount: \\(backendTeamCount)")
            NSLog("[Practenture] TeamDashboardView onAppear DONE")
