...
cmd_deploy() {
    ...
    local EMAIL_PROVIDER SES_REGION SES_SENDER SES_SNS_TOPIC_ARN EMAIL_SUPPRESSION_KEY PUBLIC_ORIGIN
...
keys = (
    ...
    "PRACTENTURE_SES_SNS_TOPIC_ARN", "PRACTENTURE_EMAIL_SUPPRESSION_KEY",
