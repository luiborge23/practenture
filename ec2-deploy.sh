...
cmd_deploy() {
    ...
    local EMAIL_PROVIDER SES_REGION SES_SENDER SES_CONFIGURATION_SET SES_SNS_TOPIC_ARN EMAIL_SUPPRESSION_KEY PUBLIC_ORIGIN
    ...
    SES_CONFIGURATION_SET="${PRACTENTURE_SES_CONFIGURATION_SET:-}"
    SES_SNS_TOPIC_ARN="${PRACTENTURE_SES_SNS_TOPIC_ARN:-}"
    EMAIL_SUPPRESSION_KEY="${PRACTENTURE_EMAIL_SUPPRESSION_KEY:-}"
    ...
    if [ -f "$SCRIPT_DIR/.env" ]; then
        ...
        SES_CONFIGURATION_SET="${SES_CONFIGURATION_SET:-${PRACTENTURE_SES_CONFIGURATION_SET:-}}"
        SES_SNS_TOPIC_ARN="${SES_SNS_TOPIC_ARN:-${PRACTENTURE_SES_SNS_TOPIC_ARN:-}}"
        EMAIL_SUPPRESSION_KEY="${EMAIL_SUPPRESSION_KEY:-${PRACTENTURE_EMAIL_SUPPRESSION_KEY:-}}"
    fi
    if [ -z "$EMAIL_SUPPRESSION_KEY" ]; then
        EMAIL_SUPPRESSION_KEY=$(python3 -c "import secrets; print(secrets.token_hex(32))")
    fi
    ...
    PRACTENTURE_SES_CONFIGURATION_SET="$SES_CONFIGURATION_SET" \
    PRACTENTURE_SES_SNS_TOPIC_ARN="$SES_SNS_TOPIC_ARN" \
    PRACTENTURE_EMAIL_SUPPRESSION_KEY="$EMAIL_SUPPRESSION_KEY" \
...
keys = (
    ...
    "PRACTENTURE_SES_CONFIGURATION_SET", "PRACTENTURE_SES_SNS_TOPIC_ARN",
    "PRACTENTURE_EMAIL_SUPPRESSION_KEY",
